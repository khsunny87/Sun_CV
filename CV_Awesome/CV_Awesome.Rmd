...
#pronouns: he/his/him
address: "Department of Cardiothoracic Surgery, Mayo Clinic, Jacksonville, FL"
...
```{r}
library(tibble)
read_csv("../Input/education.csv", col_types = "ccc") %>% 
...
```{r}
read_csv("../Input/experience.csv", col_types = "ccc") %>% 
  detailed_entries(Position, Year, Institution,Where)
```

\faIcon{trophy} Honors and Awards
============================

```{r}
read_csv("../Input/award.csv", col_types = "ccc") %>% 
  detailed_entries(with=Title, when=Year, what=Where)
```

\faIcon{users} Professional Memberships
============================
**Member, Korean Society for Thoracic and Cardiovascular Surgery**
...
```{r, results='asis'}
read_csv("../Input/presentation.csv", col_types = "ccc") %>% 
